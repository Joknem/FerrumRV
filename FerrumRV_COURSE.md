...
>
> Rust 教学采用 just-in-time 原则：在系统任务第一次需要某个 Rust 概念时讲清楚它，而不是提前灌输全部语言特性。重点确保学生真正理解 ownership、borrow、lifetime、enum/match、trait、Result、testing、no_std、unsafe 和 raw pointer。
>
