...
- 当前 Phase：A
- 当前 Chapter：4
- 当前 Milestone：4.2 — ADD / SUB
- 已通过 milestone：0.1、0.2、1.1、1.2、2.1、2.2、3.1、3.2、3.3、4.1、4.2
- 当前状态：4.2 验收通过；十一个测试及格式检查通过，无警告。
- 当前待验收项：4.2 无；待学生提交。Chapter 4 尚未结束。
- 下一目标：4.3 EBREAK / halt 已解锁，先讨论真实断点语义与教学停止协议。
