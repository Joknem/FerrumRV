...
- 当前 Phase：A
- 当前 Chapter：4
- 当前 Milestone：4.1 — ADDI execute
- 已通过 milestone：0.1、0.2、1.1、1.2、2.1、2.2、3.1、3.2、3.3、4.1
- 当前状态：4.1 验收通过；十个测试及格式检查通过，无测试编译警告。
- 当前待验收项：4.1 无；待学生小步提交，Chapter 4 尚未结束。
- 下一目标：4.2 ADD / SUB 已解锁，尚未开始实现。
